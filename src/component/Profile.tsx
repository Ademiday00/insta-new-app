    ...
    <>
      <div className="m-0 p-0 mx-lg-5 mx-md-5">
        <div className="m-0 p-0  mx-lg-5 mx-md-5">
          ...
          <div className="d-flex justify-content-between align-items-center m-3 text-white ms-md-5">
            <img
              src={YourStory}
              alt="Profile"
              className="rounded-circle me-4 responsive-img"
...
`}
            ...
            <div className="d-flex justify-content-between align-items-center gap-4 pt-3 me-4 following me-md-5">
              <div className="">
                <a
